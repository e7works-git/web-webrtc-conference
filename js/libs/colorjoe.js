...
(function (global, factory) {
          ...
          e.installColorSpace('XYZ', ['x', 'y', 'z', 'alpha'], {
            fromRgb: function () {
              var a = function (e) {
                ...
                n = a(this._blue);
              return new e.XYZ(
                0.4124564 * t + 0.3575761 * r + 0.1804375 * n,
                0.2126729 * t + 0.7151522 * r + 0.072175 * n,
                0.0193339 * t + 0.119192 * r + 0.9503041 * n,
                this._alpha
              );
            },
            rgb: function () {
              ...
              return new e.RGB(
                n(3.2404542 * a + -1.5371385 * t + -0.4985314 * r),
                n(-0.969266 * a + 1.8760108 * t + 0.041556 * r),
                n(0.0556434 * a + -0.2040259 * t + 1.0572252 * r),
                this._alpha
              );
            },
            lab: function () {
          ...
          e.installColorSpace('CMYK', ['cyan', 'magenta', 'yellow', 'black', 'alpha'], {
            ...
            fromRgb: function () {
              var a = this._red,
                ...
                s = 1;
              return (
                a || t || r ? ((s = Math.min(n, Math.min(i, o))), (n = (n - s) / (1 - s)), (i = (i - s) / (1 - s)), (o = (o - s) / (1 - s))) : (s = 1),
                new e.CMYK(n, i, o, s, this._alpha)
              );
            },
          });
        },
  ...
  function SliderX(p, a) {
    p.style.left = clamp(a * 100, 0, 88.8888) + '%';
  }
  function Y(p, a) {
